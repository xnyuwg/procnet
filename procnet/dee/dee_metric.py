...
def measure_event_table_filling(pred_record_mat_list, gold_record_mat_list, event_type_roles_list, event_type_list, avg_type='micro'):
    """
    ...
    event_each_types = {}
    for event_idx, role_num in enumerate(event_role_num_list):
        event_tpye_name = event_type_list[event_idx]
        ...
        event_each_type = {
            'micro_precision': micro_event_prf1[0],
            'micro_recall': micro_event_prf1[1],
            'micro_f1': micro_event_prf1[2],
        }
        event_each_types[event_tpye_name] = event_each_type

    micro_g_prf1 = get_prec_recall_f1(*g_tpfpfn_stat)

    score_results = {
        'micro_precision': micro_g_prf1[0],
        'micro_recall': micro_g_prf1[1],
        'micro_f1': micro_g_prf1[2],
        'each_event': event_each_types,
    }
